...
@Component({
  selector: 'app-details-entrega',
  templateUrl: './entrega-form.component.html',
  styleUrls: ['./entrega-form.component.scss']
})
export class EntregaFormComponent extends BaseResourceFormComponent<Entrega> implements AfterViewInit, OnDestroy { 


  JSONPath : string = environment.entregaJSONPath; 
...
//  private ngUnsubscribe = new Subject(); 
  ...
  constructor(
    protected entregaService: EntregaService,//Linha alterável com base na classe 
    protected injector: Injector, 
    private generatedFormFactoryService: GeneratedFormFactoryService, 
    private formGeneratorService: FormGeneratorService 
  ) { 
    super(injector, new Entrega(), entregaService, Entrega.fromJson);//Linha alterável com base na classe 
